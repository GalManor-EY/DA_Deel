...
select DIRECTION, RECEIVER_ID, SENDER_ID, count(*), SUM(TRY_CAST(usd_amount AS DECIMAL(18,2))) AS sum_usd_amount
FROM dbo.stg_tms_transactions_q4_2025 f
where RECONCILIATION_ID in('26921918','26921927')
group by DIRECTION, RECEIVER_ID, SENDER_ID;
...
select invoice_period, sum(TRY_CAST(usd_amount AS DECIMAL(18,2))) as USD_amount
